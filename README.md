...
This book is intended for every reader, from the beginner to the more proficient C++
programmer. However, some previous experience with C++ is useful.
